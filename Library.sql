...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `CalculateLateFee`(
    p_return_date DATE,
    p_due_date DATE,
    p_daily_fee DECIMAL(10, 2)
...
BEGIN
    ...
    IF days_late > 0 THEN
        SET late_fee = days_late * p_daily_fee;
    ELSE
        SET late_fee = 0;
    END IF;
...
/*!50003 DROP FUNCTION IF EXISTS `CheckAvailableCopies` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `CheckAvailableCopies`(p_book_id INT) RETURNS tinyint(1)
    DETERMINISTIC
BEGIN
    DECLARE available BOOLEAN;
    
    -- Check if there are any copies of the book available
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `AddNewBook` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `AddNewBook`(
...
BEGIN
    ...
    ELSE
        INSERT INTO books (title, author, published_year, isbn, copies)
        VALUES (p_title, p_author, p_published_year, p_isbn, p_copies);
        SELECT LAST_INSERT_ID() AS NewBookID;
    END IF;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `AddNewMember`(
...
BEGIN
	if exists (select 1 from members where email = p_email) then
		...
		INSERT INTO members (first_name, last_name, date_of_birth, email, phone) VALUES (p_first_name, p_last_name, p_date_of_birth, p_email, p_phone);
...
-- Dump completed on 2024-10-21 14:29:05
